...
public class SwiftBluetoothScanner_ListenerProxy implements SwiftBluetoothScannerBinding.Listener {

    // address of proxy object
    long __swiftObject;

    SwiftBluetoothScanner_ListenerProxy( long __swiftObject ) {
